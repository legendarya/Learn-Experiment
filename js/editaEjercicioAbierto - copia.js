...
$(document).ready(function(){
	...
	$("#tabla_preguntas input").keyup(function(){
	...
	$("#tabla_preguntas td").mouseup(selectCell);
});

function selectCell(){
	var input=$('input',this);
	$(this).html('<input type="text" id="'+input.attr('id')+'" name="'+input.attr('name')+'" value="'+input.attr('value')+'"/>');
	$('input',this).focus();
	$('input',this).blur(exitTableField);
	$('input',this).keyup(writeTableField);
}

function writeTableField(){
	if($(this).attr('id').charAt(1)=='0'){
		if($(this).attr('value'))
			$(".ventana_ejercicio #name").text($(this).attr('value'))
		else $(".ventana_ejercicio #name").text('Pregunta')
...
function exitTableField(){
	$(this).parent().html('<input type="hidden" id="'+$(this).attr('id')+'" name="'+$(this).attr('name')+'" value="'+
