...
class LikeCondition extends EqualCondition{
	
	function sql(){
		return $this->field.' like "%'.mysql_real_escape_string($this->value).'%"';
	}
}
...
class LessOrEqualThanCondition extends EqualCondition{
	function sql(){
		return $this->field.'<="'.mysql_real_escape_string($this->value).'"';
	}
}
...
class MoreOrEqualThanCondition extends EqualCondition{
	function sql(){
		return $this->field.'>="'.mysql_real_escape_string($this->value).'"';
	}
}
